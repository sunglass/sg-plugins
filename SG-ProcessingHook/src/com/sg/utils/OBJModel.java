...
public class OBJModel {
	...
	public void scale(float scaleX, float scaleY, float scaleZ) {
		...
		if (vertexCount == 0)
			System.out.println("OBJTransform - \tThe model has no verts. Have you loaded it yet?");
		else {
			PVector v;
				...
				if (elements.length > 0) {
					if (elements[0].equals("v")) {
						...
						if (elements.length < 3)
							System.out.println("Warning: potential model data error");
